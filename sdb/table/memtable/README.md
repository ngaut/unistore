...
Showing top 10 nodes out of 37 (cum >= 12.50MB)
  ...
  116.92MB  8.73% 86.31%   116.92MB  8.73%  bytes.makeSlice
   ...
   34.50MB  2.58% 93.56%    34.50MB  2.58%  github.com/ngaut/unistore/sdb/table.(*BlockIterator).parseKV
   25.50MB  1.90% 95.46%   100.06MB  7.47%  github.com/pingcap/badger/y.(*MergeIterator).Next
   21.06MB  1.57% 97.04%    21.06MB  1.57%  github.com/ngaut/unistore/sdb/table.(*Table).read
   12.50MB  0.93% 97.97%    12.50MB  0.93%  github.com/ngaut/unistore/sdb/table.header.Encode
...
Showing top 10 nodes out of 41 (cum >= 185.62MB)
  ...
  142.43MB  7.03% 79.19%   142.43MB  7.03%  bytes.makeSlice
   ...
   99.50MB  4.91% 89.04%    99.50MB  4.91%  main.newValue
      75MB  3.70% 92.74%       75MB  3.70%  github.com/ngaut/unistore/sdb/table.(*BlockIterator).parseKV
   44.62MB  2.20% 94.94%    44.62MB  2.20%  github.com/ngaut/unistore/sdb/table.(*Table).read
