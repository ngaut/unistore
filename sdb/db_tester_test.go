...
func newShardTester(db *DB) *shardTester {
	tester := &shardTester{
		shardIDAlloc: 0,
...
func (st *shardTester) finishSplit(shardID, ver uint64, props []*sdbpb.Properties) error {
...
func (st *shardTester) Recover(db *DB, shard *Shard, meta *ShardMeta, toState *sdbpb.Properties) error {
