...
type Response struct {
	Error      string
	Compaction *sdbpb.Compaction `json:"compaction"`
}
...
func (s *Server) ServeHTTP(writer http.ResponseWriter, request *http.Request) {
	...
	resp := &Response{
		Compaction: &sdbpb.Compaction{Cf: int32(req.CF), Level: uint32(req.Level), TopDeletes: req.Tops},
	}
	if req.Level == 0 {
...
func resultToTableCreate(cf, level int, result *sstable.BuildResult) *sdbpb.TableCreate {
