...
func (n *Node) Start(ctx context.Context, engines *Engines, trans Transport, snapMgr *SnapManager, pdWorker *worker, storeMeta *storeMeta, storeMetaLock *sync.RWMutex, copHost *CoprocessorHost) error {
	...
	err = n.startNode(engines, trans, snapMgr, pdWorker, storeMeta, storeMetaLock, copHost)
	return err
}
...
func (n *Node) startNode(engines *Engines, trans Transport, snapMgr *SnapManager, pdWorker *worker, storeMeta *storeMeta, storeMetaLock *sync.RWMutex, copHost *CoprocessorHost) error {
	log.Infof("start raft store node, storeID: %d", n.store.GetId())
	return n.system.start(n.store, n.cfg, engines, trans, n.pdClient, snapMgr, pdWorker, storeMeta, storeMetaLock, copHost)
}
