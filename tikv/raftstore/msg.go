...
const (
	...
	MsgTypeApplyGenSnapshot  MsgType = 307

	// GenerateEngineMetaChange is generated by local engine, it generates a meta change raft log.
	MsgTypeGenerateEngineMetaChange MsgType = 401
	MsgTypeEngineLoadFile           MsgType = 402
