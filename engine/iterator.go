...
func (s *SnapAccess) newIterator(cf int, reverse bool) table.Iterator {
...
func (s *SnapAccess) appendMemTblIters(iters []table.Iterator, memTbls *memTables, cf int, reverse bool) []table.Iterator {
...
func (s *SnapAccess) appendL0Iters(iters []table.Iterator, l0s *l0Tables, cf int, reverse bool) []table.Iterator {
